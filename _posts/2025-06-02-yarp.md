...
tags: [.net, yarp, reverse proxy, prometheus, grafana, vibe-coding, ai] # TAG names should always be lowercase.
...
I'd wanted to learn the basics of Prometheus and Grafana for a while. I have experience with Azure, but it's always good to know open-source alternatives. While deciding which metrics to set up, I learned about the [**RED** and **USE** monitoring methodologies](https://grafana.com/blog/2018/08/02/the-red-method-how-to-instrument-your-services/).
