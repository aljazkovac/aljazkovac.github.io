...
permalink: /posts/overthewire-wargames/
...
The trick was finding which of the suggested commands (`ssh, telnet, nc, openssl, s_client, nmap`) could be used for this.
After some digging `nc` seems to do the trick:
