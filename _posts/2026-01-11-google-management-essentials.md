...
graph TD
    ...
    A[Feedback] --- B[Coaching]
    end

    A --- A1[Timely & Actionable]
    A --- A2[Focus on Past/Present Behavior]
    B --- B1[Collaborative & Inquisitive]
    B --- B2[Focus on Future Growth]

    style A fill:#f5f5f5,stroke:#424242,color:#212121
...
```mermaid
graph LR
    S[<b>Situation</b><br/>The specific context] --> B[<b>Behavior</b><br/>What was observed]
    B --> I[<b>Impact</b><br/>The result of the behavior]

    style S fill:#f5f5f5,stroke:#424242,color:#212121
    style B fill:#f5f5f5,stroke:#424242,color:#212121
    style I fill:#e1f5fe,stroke:#01579b,color:#01579b
```
...
```mermaid
graph TD
    Cycle([Continuous Review Cycle])

    Cycle --- C1[<b>Foundation</b><br/>Set clear expectations]
    Cycle --- C2[<b>Preparation</b><br/>Gather 360 perspectives]
    Cycle --- C3[<b>Conversation</b><br/>Two-way dialogue]
    Cycle --- C4[<b>Momentum</b><br/>Commit to development]

    style Cycle fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#01579b
    style C1 fill:#f5f5f5,stroke:#424242,color:#212121
    style C2 fill:#f5f5f5,stroke:#424242,color:#212121
    style C3 fill:#f5f5f5,stroke:#424242,color:#212121
    style C4 fill:#f5f5f5,stroke:#424242,color:#212121
```
...
```mermaid
graph TD
    A([Self-Awareness Loop])

    A --- B[<b>Internal</b><br/>Values, emotions, and preferences]
    A --- C[<b>External</b><br/>How others perceive your actions]
    ...
    style A fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#01579b
    style B fill:#f5f5f5,stroke:#424242,color:#212121
    style C fill:#f5f5f5,stroke:#424242,color:#212121
```
...
```mermaid
graph LR
    P[<b>Practice</b><br/>Apply new skills] --> R[<b>Reflect</b><br/>Evaluate the outcome]
    R --> L[<b>Learn</b><br/>Adjust and grow]
    L --> P

    style P fill:#f5f5f5,stroke:#424242,color:#212121
    style R fill:#f5f5f5,stroke:#424242,color:#212121
    style L fill:#e1f5fe,stroke:#01579b,color:#01579b
```
